    ...
    <script type="application/ld+json">
        {
          ...
          "alternateName": "Dora",
          "url": "https://dora.uz/",
          "logo": "https://dora.uz/assets/images/logo/dora-logo-color.svg",
          "contactPoint": [{
            "@type": "ContactPoint",
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-2 col-md-3 col-4">
                    ...
                    <a href="{{route('index')}}" class="thumbnail">
                        <img class="active-light" src="/assets/images/logo/dora-logo-color.svg" alt="DORA Logo">
                ...
                <div class="col-lg-7 d-none d-xl-block">
                    <div class="main-header">
                        <nav class="main-nav">
                            ...
                            <li>
                                <a href="{{route('price')}}">@lang('index.price')</a>
                            </li>
                            <li>
                            ...
                            <li class="has-droupdown ">
                                ...
                                <ul class="submenu">
                                    <li><a class="single" href="/lang/ru"><img width="25px" height="15px"
                                                src="/assets/images/russia-flag.png" alt="RU"> RU</a></li>
                                    <li><a class="single" href="/lang/uz"><img width="25px" height="15px"
                                                src="/assets/images/uzbekistan-flag.png" alt="UZ"> UZ</a></li>
                                    <li><a class="single" href="/lang/en"><img width="25px" height="15px"
                                                src="/assets/images/usa-flag.png" alt="EN"> EN</a></li>
                                </ul>
                            </li>
    ...
    <div id="side-bar" class="side-bar">
        ...
        <div class="rts-sidebar-menu-desktop">
            <a class="logo-1" href="/"><img class="logo" src="/assets/images/logo/dora-logo-color.svg" alt="DORA Logo"></a>
                ...
                <div class="col-sm-10 col-lg-6" 
                    ...
                    <div class="project-info" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                        <div class="d-flex justify-content-center" style="margin-bottom: 5rem;">
                            <img src="/assets/images/logo/dora-logo-color.svg" alt="DORA" width="67%"/>
                        </div>
                        <div class="info-head">
                ...
                <div class="row g-0">
                    <div class="col-lg-3">
                        <div class="single-footer-three-wized">
                            <div class="header">
                                <a href="/">
                                    <img src="/assets/images/logo/dora-logo-white.svg" alt="Footer_logo" width="210px">
                                </a>
                            </div>
